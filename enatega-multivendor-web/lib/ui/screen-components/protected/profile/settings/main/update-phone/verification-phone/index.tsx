...
const VerificationPhone = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 sm:p-6 md:p-8 flex flex-col items-center bg-white rounded-3xl shadow-md">
      <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-2">
        We have sent OTP code to
      </h2>

      <p className="text-lg sm:text-xl font-semibold text-center text-gray-800 mb-3">

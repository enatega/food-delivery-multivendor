      ...
      <div className="p-4 md:p-8 space-y-6">
        {hasReviews ? (
          <>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white border rounded-xl p-5 shadow-sm gap-4">
              ...
              <div className="w-full md:w-2/3 space-y-2">
                {ratingBreakdown.map(({ stars, count, percentage }) => (
                  ...
                  >
                    <span className="w-6 text-sm font-medium text-gray-700">{stars}</span>
                    <Rating
                      value={1}
                      stars={1}
                      readOnly
                    ...
                    />
                    <div className="flex-1 bg-gray-200 h-2 rounded-full min-w-[40%]">
                      <div
            ...
            <div className="space-y-4">
              {reviewResult.reviews.map((review) => (
                <div
                  key={review._id}
                  className="border rounded-lg p-4 md:p-5 shadow-sm bg-white"
                >
          ...
          >
            ...
            <p className="text-gray-600 max-w-xs md:max-w-md text-sm md:text-base">
              Be the first to share your experience and help others make better choices!
            </p>
          </motion.div>
        )}
      </div>

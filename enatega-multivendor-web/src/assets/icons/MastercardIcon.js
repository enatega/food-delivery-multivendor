...
function MastercardIcon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={32} height={24} viewBox="0 0 32 24" {...props}>
      <g fill="none" fillRule="evenodd">
        <path d="M2 0h28a2 2 0 012 2v20a2 2 0 01-2 2H2a2 2 0 01-2-2V2a2 2 0 012-2z" fill="#000" />
        <path fill="#FF5F00" fillRule="nonzero" d="M12.094 5.24h7.702v12.795h-7.702z" />
        <path
          fill="#F79E1B"
          fillRule="nonzero"

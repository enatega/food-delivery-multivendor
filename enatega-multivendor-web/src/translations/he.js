const he = {
  translation: {
    ...
    connectSubText:"הצטרפו לפלטפורמה שמספקת נוחות, גמישות וצמיחה לכל המעורבים. בין אם אתם שליחים המחפשים להרוויח, מסעדה שרוצה להתרחב, או לקוח שחושק בארוחות טעימות – אנחנו כאן בשבילכם!",
    PlatformText: "למה להצטרף לפלטפורמה שלנו?",
    PlatformSubtext: "אנחנו לא רק פלטפורמת משלוחי אוכל – אנחנו קהילה שנועדה להועיל לכולם. לכן אלפי שליחים, מסעדות ולקוחות סומכים עלינו:",
    ForRider: "לשליחים:",
    platformRiderText: "הרוויחו בלוח הזמנים שלכם, קבלו תשלומים מהירים ותיהנו מכלים קלים לניהול משלוחים.",
    ForRestaurant: "למסעדות:",
    platformRestaurantText: "הרחיבו את טווח ההגעה שלכם, הפכו את ניהול ההזמנות לפשוט יותר, והגדילו את ההכנסות עם ניתוחים בזמן אמת.",
    ForCustomer: "ללקוחות:",
    platformCustomerText: "תיהנו ממגוון רחב של מסעדות, משלוח מהיר ואפליקציה ואתר ידידותיים למשתמש.",
    orderText: "הזמן את המועדפים שלך בכל זמן, בכל מקום",
    orderSubText1: "חווה את הנוחות של having all your favorite restaurant meals and cuisines in one place, delivered straight to your door—fast and fresh. הורד את אפליקציית Enatega היום, והפוך כל חשק למאכל טעים למציאות.",
    orderSubText2: "גלה מגוון רחב של אפשרויות, ממנות אהובות מקומיות ואוכל מנחם ועד מנות גורמה, אוכל בריא ועוד.",
    orderSubText3: "הורד את אפליקציית Enatega היום, והפוך כל חשק למאכל טעים למציאות.",
    platformFeatureText: "תכונות הפלטפורמה שמבליטות אותנו.",
    platformFeatureSubText: "אנו מספקים תכונות מתקדמות כדי להבטיח שהחוויה שלך תהיה חלקה וללא מאמץ:",

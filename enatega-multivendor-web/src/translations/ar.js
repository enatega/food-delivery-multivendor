const ar = {
  translation: {
   ...
   connectSubText:"انضم إلى المنصة التي توفر الراحة والمرونة والنمو للجميع. سواء كنت سائقًا يبحث عن دخل، أو مطعمًا يسعى للتوسع، أو عميلًا يتوق إلى وجبات لذيذة، نحن هنا من أجلك!",
   PlatformText: "لماذا تنضم إلى منصتنا؟",
    PlatformSubtext: "نحن لسنا مجرد منصة لتوصيل الطعام – نحن مجتمع تم إنشاؤه لتحقيق الفائدة للجميع. لهذا السبب يثق بنا آلاف السائقين والمطاعم والعملاء:",
    ForRider: "للسائقين:",
    platformRiderText: "اكسب وفق جدولك، واحصل على مدفوعات سريعة، واستمتع بأدوات سهلة الاستخدام لإدارة التوصيلات.",
    ForRestaurant: "للمطاعم:",
    platformRestaurantText: "وسّع نطاقك، وقم بتبسيط إدارة الطلبات، وزد من إيراداتك باستخدام التحليلات في الوقت الفعلي.",
    ForCustomer: "لعملاء:",
    platformCustomerText: "استمتع بمجموعة واسعة من المطاعم، وتسليم سريع، وتطبيق وموقع إلكتروني سهل الاستخدام.",
    orderText: "اطلب المفضلات لديك في أي وقت وأي مكان",
    orderSubText1: "استمتع براحة الحصول على جميع وجبات ومأكولات المطاعم المفضلة لديك في مكان واحد، مع توصيلها مباشرة إلى باب منزلك بسرعة وطازجة. قم بتنزيل تطبيق Enatega اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    orderSubText2: "استكشف مجموعة واسعة من الخيارات، من المفضلات المحلية والطعام المريح إلى الأطباق الراقية، الأطعمة الصحية والمزيد.",
    orderSubText3: "قم بتنزيل تطبيق Enatega اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    platformFeatureText: "ميزات المنصة التي تجعلنا نبرز.",
    platformFeatureSubText: "نحن نقدم ميزات متطورة لضمان أن تكون تجربتك سلسة وخالية من المتاعب:",

...
const ar = {
  translation: {
    ...
    saveButton: "يحفظ",
    footerText:
      `${toTitleCase(APP_NAME)} عبارة عن منصة مفتوحة المصدر لإدارة التسليم لـ مستقبل. نحن نعطي الأولوية للابتكار والمرونة والقدرة على تحمل التكاليف، وتقديم حل قابل للتطوير وقابل للتخصيص يعمل على تبسيط عملك عمليات التسليم.`,

export const ar = {
  ...
  "ITEMS AND QUANTITY": "المنتجات والكمية",
  PRICE: "السعر",
  Total: "المجموع",
  ...
  "Dark": "داكن",
  "Light": "فاتح",
  "Start time must be earlier than end time": "يجب أن يكون وقت البدء قبل وقت الانتهاء",
  "End time must be greater than start time": "يجب أن يكون وقت الانتهاء بعد وقت البدء",
  "Time slot overlaps with another existing slot": "يتداخل الوقت مع فترة زمنية موجودة أخرى",
  ...
  "Chat": "الدردشة",
  "Unable to connect. Please check your internet and try again.": "غير قادر على الاتصال. يرجى التحقق من الإنترنت الخاص بك والمحاولة مرة أخرى.",
  "Invalid username or password": "اسم المستخدم أو كلمة المرور غير صالحة",
  "Unable to connect. Please try again.": "غير قادر على الاتصال. يرجى المحاولة مرة أخرى.",
  "Uploading image...": "جارٍ تحميل الصورة...",
  "Chats Here": "الدردشات هنا",
  "Please Wait": "من فضلك انتظر",
  "Are you sure you want to logout?": "هل أنت متأكد أنك تريد تسجيل الخروج؟",
  "Cancel": "إلغاء",
  "User ID is missing": "معرف المستخدم مفقود",
  "Navigation Error": "خطأ في التنقل",
  "Rider location is unavailable.": "موقع الراكب غير متاح.",
  "Restaurant location is unavailable.": "موقع المطعم غير متوفر.",
  "Delivery location is unavailable.": "مكان التسليم غير متوفر.",
  "Could not open maps application": "لا يمكن فتح تطبيق الخرائط",
  "An error occurred when trying to open maps": "حدث خطأ أثناء محاولة فتح الخرائط",
  "Map not loaded.": "لم يتم تحميل الخريطة.",
  "Location data is unavailable.": "بيانات الموقع غير متاحة.",
  "Pickup Address": "عنوان الاستلام",
  "Confirm you have collected": "تأكيد أنك قد جمعت",
  "Mark as Delivered?": "وضع علامة \"تم التسليم\"؟",
  "This completes the order and cannot be undone.": "يؤدي هذا إلى إكمال الطلب ولا يمكن التراجع عنه.",
  "Please try again later": "يرجى المحاولة مرة أخرى لاحقا",
  "has overlapping slots": "لديه فتحات متداخلة",
  "Work Schedule has been updated successfully": "تم تحديث جدول العمل بنجاح",

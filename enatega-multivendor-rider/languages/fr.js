...
export const fr = {
  ...
  welcome: `Bienvenue dans ${toTitleCase(
    APP_NAME
  )}, parfois tout ce dont vous avez besoin est de l'amour. Mais un peu de nourriture maintenant et ensuite ne fait pas mal.`,
  ...
  enategaLocationText: `${toTitleCase(
    APP_NAME
  )} utilise votre emplacement pour des fonctionnalités telles que la recherche de commandes à proximité et le suivi des commandes des clients !`,
  emptyUsernameError: 'Le nom dutilisateur est requis!',
  emptyPasswordError: 'Le mot de passe est requis!',
  loginFlashMsg: 'Connecté',
  enategaCash: `${toTitleCase(APP_NAME)} Argent Liquide`,
  ASSIGNED: 'ASSIGNÉ',
  PICKED: 'CHOISI',

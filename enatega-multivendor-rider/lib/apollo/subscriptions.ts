...
export const SINGLE_VENDOR_SUBSCRIPTION_ZONE_ORDERS = gql`
  subscription SingleVendorSubscriptionZoneOrders($zoneId: String!) {
    subscriptionZoneOrders(zoneId: $zoneId) {
      zoneId
      origin
      order {
...
export const SINGLE_VENDOR_SUBSCRIPTION_ASSIGNED_RIDER = gql`
  subscription SingleVendorSubscriptionAssignRider($riderId: String!) {
    subscriptionAssignRider(riderId: $riderId) {
      order {
        _id
        orderId

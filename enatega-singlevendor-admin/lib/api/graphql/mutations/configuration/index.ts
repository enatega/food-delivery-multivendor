...
export const SAVE_GENERAL_CONFIGURATION = gql`
  mutation SAVE_GENERAL_CONFIGURATION(
    $configurationInput: GeneralConfigurationInput!
  ) {
    saveGeneralConfiguration(configurationInput: $configurationInput) {
      isAppLaunched
    }
  }
`;

  ...
  return !isLoading ? (
    <div className="flex w-full flex-col justify-center gap-y-1">
      ...
      <input
        id="timeInput"
        type="date"
        className={`h-10 w-full dark:text-white rounded-lg border border-gray-300 dark:border-dark-600 px-8 text-sm outline-none focus:shadow-none dark:bg-gray-900 focus:outline-none ${className}`}

    ...
    <div className="flex flex-col items-center p-4 border dark:border-dark-600 rounded-lg shadow-sm mx-auto">
      <div className="flex flex-col md:flex-row items-center w-full">
        ...
        <div className="basis-[30%] flex items-center flex-wrap gap-4 justify-center sm:justify-end mt-4 md:mt-0">
          ...
          <span className='p-2 text-xs rounded-full bg-gray-100 dark:bg-dark-600 dark:text-white'>{comments ? comments : 'No comments'}</span>
        </div>
      </div>
      {reviewContent && showModal && (
        <div className="fixed inset-0 flex items-center justify-center  bg-black bg-opacity-50 z-[1000]">
          <div className="bg-white dark:bg-dark-950 p-6 rounded-lg border dark:border-dark-600 shadow-lg max-w-sm w-full relative">
            <h2 className="text-xl dark:text-white font-semibold mb-4">Review</h2>

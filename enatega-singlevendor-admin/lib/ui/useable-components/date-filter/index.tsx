...
export default function DashboardDateFilter({
  ...
  return (
    <div className="flex items-center justify-center p-3 ">
      <div className="w-full rounded-lg bg-white dark:bg-dark-900 shadow-lg border dark:border-dark-600">
        ...
        <div className="flex flex-col items-center justify-between space-y-4 p-4 md:flex-row md:space-x-4 md:space-y-0">
          <div className="flex w-full flex-col">
            ...
            <div className="relative">
              ...
              <FontAwesomeIcon
                icon={faCalendarAlt}
                className="absolute left-3 top-1/2 -translate-y-1/2 transform text-gray-400 dark:text-white"
              />
            </div>
          </div>
          <div className="flex w-full flex-col">
            <label className="mb-2 font-semibold dark:text-white">{t('End Date')}</label>
            <div className="relative">
              <CustomDateInput

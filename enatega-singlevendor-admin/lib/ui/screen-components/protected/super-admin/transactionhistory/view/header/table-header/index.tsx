    ...
    <div className="flex flex-row gap-4 p-4 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex gap-4">
        <span className="p-input-icon-left">
          <i className="pi pi-search w-0 h-0 ml-2 dark:text-gray-300 " />
          <CustomTextInput className="w-[14rem] h-10 border-[1px] font-light border-gray-300 rounded-[0.3rem] pl-8 pr-3 text-black dark:text-white"

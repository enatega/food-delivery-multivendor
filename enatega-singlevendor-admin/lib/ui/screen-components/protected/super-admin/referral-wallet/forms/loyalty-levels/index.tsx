...
export default function LoyaltyLevelsForm({
  ...
  return (
    <Sidebar
      ...
      position="right"
      className="w-full sm:w-[450px] dark:border-dark-600 border dark:bg-dark-950 dark:text-white "
    >
      <Formik
          ...
          return (
            <Form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium dark:text-white text-gray-700">
                    {t('Gold')}
                  </label>
                  <CustomNumberField
                    value={values.gold}
                    ...
                    min={0}
                    className="dark:bg-dark-950 bg-white dark:border dark:border-dark-600"
                    style={{
                      borderColor: errors?.gold ? 'red' : '',
                ...
                <div>
                  ...
                  <CustomNumberField
                    ...
                    className="dark:bg-dark-950 bg-white dark:border dark:border-dark-600"
                    style={{
                      borderColor: errors?.platinum ? 'red' : '',
                      borderRadius: '0.375rem',
                      fontSize: '0.875rem',
                      padding: '0.5rem 0.75rem',
                      height: '2.5rem',
                ...
                <button
                  className="float-end h-10 w-fit rounded-md border-gray-300 border dark:hover:bg-primary-dark dark:border-dark-600 dark:bg-primary-color bg-black px-8 text-white disabled:opacity-50"

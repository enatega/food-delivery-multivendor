              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Dropdown
                    ...
                    className="w-full dark:bg-dark-950 border  border-gray-300 dark:border-dark-600"
                     panelClassName='dark:border dark:border-dark-600'
                    style={{
                ...
                <div>
                  ...
                  <CustomNumberField
                    ...
                    className="dark:bg-dark-950 bg-white dark:border-dark-600"
                    onChange={setFieldValue}
                    style={{
                      borderColor: errors?.points ? 'red' : '',
                ...
                <div>
                  ...
                  <Dropdown
                    ...
                    panelClassName='dark:border dark:border-dark-600'
                    className="w-full dark:bg-dark-950 border dark:border-dark-600"
                    style={{

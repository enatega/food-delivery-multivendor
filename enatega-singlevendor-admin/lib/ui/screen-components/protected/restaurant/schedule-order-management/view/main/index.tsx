                            ...
                            (time: ITimeSlot, timeIndex: number) => (
                              ...
                              >
                                ...
                                <td className=" px-4 py-3">
                                  <Calendar
                                    key={`start-${dayIndex}-${timeIndex}`}
                                    value={timeStringToDate(time.startTime)}
                                    onChange={(e) => {
                                      if (e.value) {
                                        setFieldValue(
                                    ...
                                    className="w-32"
                                    inputClassName="border border-gray-300 dark:border-dark-600 dark:bg-dark-900 dark:text-white rounded px-3 py-2 w-full"
                                ...
                                <td className=" px-4 py-3">
                                  <Calendar
                                    key={`end-${dayIndex}-${timeIndex}`}
                                    value={timeStringToDate(time.endTime)}
                                    onChange={(e) => {
                                      if (e.value) {
                                        setFieldValue(

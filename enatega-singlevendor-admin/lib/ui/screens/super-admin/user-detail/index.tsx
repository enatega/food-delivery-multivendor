...
const UserDetailScreen: React.FC<UserDetailScreenProps> = ({ userId }) => {
        ...
        return (
            <div className="flex justify-center items-center h-screen p-4">
                <Card title="User Not Found" className="shadow-md border border-orange-300 bg-orange-50 text-orange-800">
                    <p className="mb-3 dark:text-white">The requested user could not be found.</p>
                    <div className="mt-4 flex justify-end">
                        <Button label="Go Back" icon="pi pi-arrow-left" className="p-button-secondary" onClick={() => router.back()} />
                    </div>
                </Card>
    ...
    const NoAddressesCard = () => (
        <div className="p-4">
            <Card title="No Addresses Found" className="shadow-md border border-gray-200 bg-gray-50 dark:text-white">
    ...
    const tabHeaderTemplate = (options: TabPanelHeaderTemplateOptions, tab: { label: string }, index: number) => {
        ...
        return (
          ...
          ${selected
                        ? 'border-b-2 border-primary-color text-primary-dark dark:bg-dark-900'
                        : 'text-gray-600 hover:text-primary-color dark:bg-dark-900'
                    }

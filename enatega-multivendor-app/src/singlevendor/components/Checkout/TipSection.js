      ...
      <Modal visible={showCustomModal} transparent animationType='fade' onRequestClose={() => setShowCustomModal(false)}>
        <View style={styles().modalOverlay}>
          <View style={styles(currentTheme).modalContent}>
            ...
            <TextInput style={styles(currentTheme).customInput} placeholder={`${currencySymbol} 0.00`} placeholderTextColor={currentTheme.fontSecondColor} keyboardType='decimal-pad' value={customAmount} onChangeText={setCustomAmount} />
            ...
            <View style={styles().modalButtons}>
              ...
              <TouchableOpacity style={[styles(currentTheme).modalButton, styles(currentTheme).modalButtonConfirm]} onPress={handleCustomTip} activeOpacity={0.7}>

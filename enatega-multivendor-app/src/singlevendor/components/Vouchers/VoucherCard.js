...
const VoucherCard = ({ voucher, currentTheme, onUse, onRemove, voucherInUse }) => {
      ...
      <View style={styles(currentTheme).card}>
        ...
        <View style={styles(currentTheme).cardInfo}>
          ...
          <View style={styles(currentTheme).bottomRow}>
            ...
            >
              <TextDefault
                textColor={isActive ? currentTheme.fontMainColor : '#FFFFFF'}
                style={styles(currentTheme).useButtonText}
                bolder
              >
               {isActive ? t('Remove') : t('Use')}
              </TextDefault>
            </TouchableOpacity>
          </View>
        </View>

...
import { View, StyleSheet, TouchableOpacity, Alert, Modal, ActivityIndicator, InteractionManager } from 'react-native'
...
const AccountManagement = () => {
  ...
  return (
    <View style={styles(currentTheme).container}>
      <SectionHeader title={t('AccountManagement')} />
      ...
      <TouchableOpacity
        style={[
          styles(currentTheme).logoutButton,
          logoutLoading && { opacity: 0.7 }
        ]}

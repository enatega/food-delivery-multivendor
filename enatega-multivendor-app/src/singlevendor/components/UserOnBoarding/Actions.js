...
const Actions = ({ t }) => {
  const { enableApple, loginButton, loginButtonSetter, loading, themeContext, currentTheme, mutateLogin, navigateToLogin, navigation, signIn ,setLoading,handleAppleLogin} = useCreateAccount()
  ...
  return (
    <View style={styles().buttonsContainer}>
      ...
      {Platform.OS === 'ios' && enableApple && <AppleAuthButton setLoading={setLoading} loading={loading} loginButton={loginButton} enableApple={enableApple} themeContext={themeContext} currentTheme={currentTheme} mutateLogin={mutateLogin} loginButtonSetter={loginButtonSetter} handleAppleLogin={handleAppleLogin} />}

...
const OptionList = ({
  ...
  console.log('all_title_here',title);
  console.log('all_subtitle_here',subtitle);
    ...
    return (
      ...
      >
        ...
        <View style={styles.textContainer}>
          ...
          {item.isPopular && <Text style={styles.badge}>{t("Popular")}</Text>}
        </View>

        {/* Price */}
        {item.price !== undefined && (
          <Text style={styles.price}>{item.price} {configuration?.currencySymbol}</Text>
        )}
      </TouchableOpacity>
    );
  };

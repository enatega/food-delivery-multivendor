      ...
      <ScrollView style={styles(currentTheme).scrollView} contentContainerStyle={styles(currentTheme).scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles(currentTheme).content}>
          ...
          <TextDefault textColor={currentTheme.fontMainColor} style={styles(currentTheme).introText}>
            {t('At FAST, we prioritize your experience and trust. This FAQ section provides answers to common questions about using our app. By using FAST, you can find the information you need to enhance your experience.') || 'At Enatega, we prioritize your experience and trust. This FAQ section provides answers to common questions about using our app. By using Enatega, you can find the information you need to enhance your experience.'}
          </TextDefault>
          ...
          <View style={styles(currentTheme).section}>
            ...
            <TextDefault textColor={currentTheme.fontMainColor} style={styles(currentTheme).sectionIntro}>
              {t('When you use FAST, we may collect the following types of information:') || 'When you use Enatega, we may collect the following types of information:'}
            </TextDefault>
          ...
          <View style={styles(currentTheme).section}>
            ...
            <View style={styles(currentTheme).bulletList}>
              ...
              <View style={styles(currentTheme).bulletItem}>
                ...
                <TextDefault textColor={currentTheme.fontMainColor} style={styles(currentTheme).bulletText}>
                  {t('Improvement & Personalization: To enhance your experience with FAST.') || 'Improvement & Personalization: To enhance your experience with Enatega.'}
                </TextDefault>
              </View>
              <View style={styles(currentTheme).bulletItem}>
                <TextDefault textColor={currentTheme.fontMainColor} style={styles(currentTheme).bullet}>
          ...
          <View style={styles(currentTheme).section}>
            ...
            <View style={styles(currentTheme).bulletList}>
              ...
              <View style={styles(currentTheme).bulletItem}>
                ...
                <TextDefault textColor={currentTheme.fontMainColor} style={styles(currentTheme).bulletText}>
                  {t('Protection: To safeguard the rights and safety of FAST and our users.') || 'Protection: To safeguard the rights and safety of Enatega and our users.'}
                </TextDefault>
              </View>
            </View>
          </View>

...
const Browse = () => {
  const { dismissKeyboard, modalVisible, setModalVisible, handleClearSearch, handleModalClose, t, currentTheme, insets, inputRef, searchTerm, setSearchTerm, data, loading, debouncedSearch, onProductPress, handleAddToCart, handleSeeAll, isSearched } = useBrowse()

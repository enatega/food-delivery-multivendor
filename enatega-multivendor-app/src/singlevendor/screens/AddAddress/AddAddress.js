  ...
  return (
    <>
      {activeState === 'searching' ? (
        ...
        <SearchedAddress currentTheme={currentTheme} t={t} addressDetail={addressDetail} selectedType={selectedType} setSelectedType={setSelectedType} loading={loading} otherAddressDetails={otherAddressDetails} setOtherAddressDetails={setOtherAddressDetails} doorBell={doorBell} setDoorBell={setDoorBell} />
      )}

...
import { SafeAreaView, View, ActivityIndicator, TouchableOpacity, RefreshControl } from 'react-native'
...
const Notifications = () => {
  ...
  const { refreshing, handleRefresh, spinnerColor } = usePullToRefresh([refetchToday, refetchPast])

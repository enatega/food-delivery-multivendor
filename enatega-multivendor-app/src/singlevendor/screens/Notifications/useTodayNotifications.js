...
import { GET_TODAY_NOTIFICATIONS_BY_TOKEN } from '../../apollo/queries'

const useTodayNotifications = ({
    skip = 0,
    limit = 10,
    skipQuery = false,
} = {}) => {
    ...
    const { data, loading, error, refetch } = useQuery(
        GET_TODAY_NOTIFICATIONS_BY_TOKEN,
        {
            variables: {
                skip,
                limit,
    ...
    const pageInfo = data?.todayNotificationsByToken

...
import { ScrollView, Alert, RefreshControl, Platform, View } from 'react-native'
...
import {
  COUPONS_BY_RESTAURANT_SINGLE_VENDOR
} from '../../apollo/queries'
...
const Vouchers = () => {
  ...
  const handleUseVoucher = async(voucher) => {
    try {
      ...
      await setModeItem('selectedVoucher', stringifiedVoucher, APP_MODES.SINGLE)

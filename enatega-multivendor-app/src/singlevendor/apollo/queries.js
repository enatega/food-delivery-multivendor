...
export const ORDER_DETAILS_PAGE = gql`
  query OrderDetailsPage($orderId: String!) {
...
export const GET_USERS_ACTIVE_ORDERS = gql`
  query GetUsersActiveOrders($limit: Int, $page: Int) {
...
export const GET_USERS_PAST_ORDERS = gql`
  query GetUsersPastOrders($limit: Int, $page: Int) {
...
export const GET_ESTIMATED_DELIVERY_TIME = gql`
  query GetEstimatedDeliveryTime($addressId: ID!) {
    getEstimatedDeliveryTime(addressId: $addressId)
  }
`

export const GET_ALL_USER_CREDITS = gql`
...
export const GET_SCHEDULE_UNTIL_NEXT_DAY_OFF = gql`
  query GetScheduleUntilNextDayOff {

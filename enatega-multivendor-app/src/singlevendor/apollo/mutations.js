...
export const LOGIN_SINGLE_VENDOR = gql`
...
export const PUSH_NOTIFICATION_TOKEN = gql`
  mutation PushSingleVendorNotificationToken($token: String) {
...
export const GIVE_FEEDBACK = gql`
  mutation GiveFeedback($feedbackInput: FeedbackInput!) {
    giveFeedback(feedbackInput: $feedbackInput) {
      success
      message
    }
  }

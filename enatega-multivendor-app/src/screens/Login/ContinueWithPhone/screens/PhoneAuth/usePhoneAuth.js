...
import { CLAIM_REFFERAL_CODE } from '../../../../../singlevendor/apollo/mutations'
...
export const usePhoneAuth = () => {
  ...
  const [mutateClaimReferralCode, { data: onClaimReferralCodeData, loading: onClaimReferralCodeLoading }] = useMutation(CLAIM_REFFERAL_CODE, {
    onCompleted: onClaimReferralCodeCompleted,
    onError: onClaimReferralCodeError
  })
  ...
  const handleReferralContinue = useCallback(
    async (referralCode) => {
  ...
  function onBoardingCompleteOnCompleted(data) {
    try {
      ...
      navigation.navigate('RefralScreen', {
        phoneAuthData: {},
        onContinue: (referalCode) => {
          mutateClaimReferralCode(referalCode)
        },
        onSkip: () => {
          navigation.navigate({
            name: 'Main',
  ...
  function onClaimReferralCodeCompleted() {
    navigation.navigate({
      name: 'Main',
      merge: true
    })
  ...
  function onClaimReferralCodeError(error) {
    console.log('🚀 ~ onClaimReferralCodeError ~ error:', error)

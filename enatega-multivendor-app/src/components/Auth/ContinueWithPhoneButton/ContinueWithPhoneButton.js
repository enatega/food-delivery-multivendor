...
const ContinueWithPhoneButton = ({ title, onPress, isLoading, isDisabled, containerStyles ,textStyle}) => {
  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <TextDefault H4 textColor={currentTheme.gray100} center bold style={[{color: isDisabled ? currentTheme.horizontalLine : currentTheme.white }, textStyle]}>
          {t(title)}
        </TextDefault>
      )}
    </TouchableOpacity>

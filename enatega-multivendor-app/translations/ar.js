...
"This restaurant doesn’t deliver to your location. Please explore restaurants available in your delivery area": "المطعم لا يقدم خدمة التوصيل إلى العنوان الذي اخترته حاليًا. يرجى استكشاف المطاعم المتوفرة في منطقة التوصيل الخاصة بك",
  ...
  "You are all up to date": "أنت محدث بالكامل",
  "No new notifications - come back soon": "لا توجد إشعارات جديدة - عد قريباً",
  "Payments": "المدفوعات",
  "Vouchers": "القسائم",
  "App supports & FAQs": "دعم التطبيق والأسئلة الشائعة",
  "Feedback": "التعليقات",
  "My conversations": "محادثاتي",
  "Change phone number": "تغيير رقم الهاتف",
  "Change email address": "تغيير عنوان البريد الإلكتروني",
  "Change profile name": "تغيير اسم الملف الشخصي",
  "Change or delete address": "تغيير أو حذف العنوان",
  "Delete account": "حذف الحساب",
  "Reset Password": "إعادة تعيين كلمة المرور",
  "Login issue": "مشكلة تسجيل الدخول",
  "How do you rate our products?": "كيف تقيم منتجاتنا؟",
  "Your feedback helps us serve you better.": "ملاحظاتك تساعدنا على خدمتك بشكل أفضل.",
  "Write your experience here...": "اكتب تجربتك هنا...",
  "Submit": "إرسال",
  "My courier hasn't arrived yet": "لم يصل ساعي التوصيل بعد",
  "I need help with my delivery": "أحتاج مساعدة في التوصيل",
  "I was overcharged": "تم فرض رسوم زائدة علي",
  "I can't contact my courier": "لا أستطيع الاتصال بساعي التوصيل",
  "How can we help you? [Automessage]": "كيف يمكننا مساعدتك؟ [رسالة تلقائية]",
  "Payment Methods": "طرق الدفع",
  "Add or Update your saved payment methods.": "أضف أو حدث طرق الدفع المحفوظة الخاصة بك.",
  "Default": "افتراضي",
  "Add payment method": "إضافة طريقة دفع",
  "Add payment methods": "إضافة طرق دفع",
  "Add a credit or debit card to quickly complete purchases.": "أضف بطاقة ائتمان أو خصم لإكمال عمليات الشراء بسرعة.",
  "Card number": "رقم البطاقة",
  "Expiration date": "تاريخ الانتهاء",
  "Expiration date (MM / YY)": "تاريخ الانتهاء (شهر / سنة)",
  "CVV": "CVV",

export const ar = {
  ...
  faq1Description:
    'لتقديم طلب، قم ببساطة بتنزيل تطبيقنا، قم بالتسجيل أو تسجيل الدخول، تصفح قائمة المطاعم المتاحة في منطقتك، اختر العناصر المرغوبة من القائمة، وانتقل لإتمام الطلب. يمكنك أيضًا تتبع طلبك في الوقت الحقيقي.',
  faq2: 'ما هي وسائل الدفع المقبولة؟',
  faq2Description:
    'نحن نقبل مجموعة متنوعة من وسائل الدفع بما في ذلك بطاقات الائتمان / الخصم، المحافظ الرقمية، والدفع عند التسليم. يمكنك اختيار خيار الدفع المفضل لديك أثناء عملية الدفع.',
  faq3: 'هل يمكنني جدولة الطلبات مُسبقًا؟',
  faq3Description:
    'نعم، يمكنك جدولة الطلبات للتسليم في وقت لاحق. ما عليك سوى تحديد وقت التسليم المطلوب أثناء عملية الدفع، وسيضمن تطبيقنا وصول طلبك إليك في الوقت المحدد.',
  faq4: 'كيف يمكنني تعديل أو إلغاء طلبي؟',
  faq4Description:
    'إذا كنت بحاجة إلى تعديل أو إلغاء طلبك، يرجى الاتصال بفريق دعم العملاء لدينا في أقرب وقت ممكن. اعتمادًا على مرحلة التحضير، قد يتم توفير تعديلات أو إلغاءات.',
  faq5: 'هل هناك متطلبات للحد الأدنى للطلب؟',
  faq5Description:
    'قد تختلف متطلبات الحد الأدنى للطلب اعتمادًا على المطعم الذي تختاره. سيتم عرض الحد الأدنى للطلب، إن كانت هناك، خلال عملية الدفع.',
  faq6: 'ماذا لو كان لدي قيود غذائية أو حساسية؟',
  faq6Description:
    'يسمح لك تطبيقنا بتصفية المطاعم استنادًا إلى التفضيلات الغذائية والحساسيات. بالإضافة إلى ذلك، يمكنك ترك تعليمات خاصة للمطعم بشأن أي قيود غذائية أو حساسيات، وسيبذلون قصارى جهدهم لتلبية احتياجاتك.',
  away: 'بعيداً ',

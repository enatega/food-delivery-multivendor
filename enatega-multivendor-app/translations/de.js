export const de = {
  ...
  faq1Description:
    'Um eine Bestellung aufzugeben, laden Sie einfach unsere App herunter, melden Sie sich an oder loggen Sie sich ein, durchsuchen Sie die Liste der verfügbaren Restaurants in Ihrer Region, wählen Sie die gewünschten Artikel aus dem Menü aus und gehen Sie zur Kasse. Sie können auch Ihre Bestellung in Echtzeit verfolgen.',
  faq2: 'Welche Zahlungsmethoden werden akzeptiert?',
  faq2Description:
    'Wir akzeptieren verschiedene Zahlungsmethoden, darunter Kredit-/Debitkarten, digitale Geldbörsen und Barzahlung bei Lieferung. Während des Bezahlvorgangs können Sie Ihre bevorzugte Zahlungsoption auswählen.',
  faq3: 'Kann ich Bestellungen im Voraus planen?',
  faq3Description:
    'Ja, Sie können Bestellungen für die spätere Lieferung planen. Wählen Sie einfach die gewünschte Lieferzeit während des Bezahlvorgangs aus, und unsere App stellt sicher, dass Ihre Bestellung zum angegebenen Zeitpunkt bei Ihnen ankommt.',
  faq4: 'Wie kann ich meine Bestellung ändern oder stornieren?',
  faq4Description:
    'Wenn Sie Ihre Bestellung ändern oder stornieren müssen, kontaktieren Sie bitte so schnell wie möglich unser Kundensupport-Team. Je nach Vorbereitungsstatus können Änderungen oder Stornierungen möglich sein.',
  faq5: 'Gibt es eine Mindestbestellmenge?',
  faq5Description:
    'Die Mindestbestellanforderungen können je nach dem von Ihnen gewählten Restaurant variieren. Der Mindestbestellbetrag, falls zutreffend, wird während des Bezahlvorgangs angezeigt.',
  faq6: 'Was ist, wenn ich diätetische Einschränkungen oder Allergien habe?',
  faq6Description:
    'Unsere App ermöglicht es Ihnen, Restaurants basierend auf diätetischen Vorlieben und Allergenen zu filtern. Zusätzlich können Sie dem Restaurant spezielle Anweisungen zu diätetischen Einschränkungen oder Allergien hinterlassen, und sie werden ihr Bestes tun, um Ihren Bedürfnissen gerecht zu werden.',
  away: 'weg',

export const en = {
  ...
  privacyIntroText: 'At Fast, your privacy and trust are our top priority. This Privacy Policy explains how we handle your information when you use our app. By using Fast, you agree to the practices described within.',
  // Terms of Use Content
  useOfService: 'Use of Service',
  termsUseOfServiceContent: 'Fast provides a platform for ordering groceries. You may use the app for personal use as long as you follow these Terms and all applicable laws. You must keep your login credentials safe and responsible for all activities under your account. You may not misuse Fast by attempting to hack, disrupt, copy, or resell our services. Any attempt to bypass security, overload servers, or use the service for illegal activity is strictly prohibited.',
  userContent: 'User Content',
  termsUserContentContent: 'You remain the owner of the order, and content you create in Fast. By using, you grant us a limited right to store, process, and transmit that content solely for the purpose of providing the service. You are responsible for ensuring that your content is legal and does not violate intellectual property rights, privacy rights, or any applicable law. Fast does not actively monitor user content but reserves the right to remove or disable access to content that appears unlawful or harmful.',
  serviceAvailabilityAndUpdates: 'Service Availability and Updates',
  termsServiceAvailabilityContent: 'We aim to keep Fast reliable and available at all times, but we cannot guarantee uninterrupted service. Occasional downtime may occur due to maintenance, updates, or technical issues. We may provide updates or new features to improve functionality. Some updates may be required for continued use of the app, and these Terms apply to all updated versions unless stated otherwise.',
  limitationOfLiability: 'Limitation of Liability',
  termsLimitationContent: 'Fast is provided "as is" and "as available." While we work to protect your files and data, we cannot guarantee absolute security or uninterrupted access. To the maximum extent allowed by the laws of Qatar, Fast will not be responsible for indirect or consequential damages, such as lost data, lost profits, or business interruptions.',
  ...
  "You need to have placed at least one order with FAST before you can invite friends.": "You need to have placed at least one order with FAST before you can invite friends.",
  ...
  "When you use FAST, we may collect the following types of information:": "When you use FAST, we may collect the following types of information:",
  ...
  "Improvement & Personalization: To enhance your experience with FAST.": "Improvement & Personalization: To enhance your experience with FAST.",
  ...
  "Protection: To safeguard the rights and safety of FAST and our users.": "Protection: To safeguard the rights and safety of FAST and our users.",
  ...
  "Email: support@fastapp.com": "Email: support@fastapp.com",

...
const useEnvVars = (env = Updates.channel) => {
  ...
  if (env === 'production' || env === 'staging') {
    return {
      ...
      GRAPHQL_URL: 'https://enatega-multivendor-api-production-7fed.up.railway.app/graphql',
      WS_GRAPHQL_URL: 'wss://enatega-multivendor-api-production-7fed.up.railway.app/graphql',
      SERVER_URL: 'https://enatega-multivendor-api-production-7fed.up.railway.app/graphql',
      SERVER_REST_URL: 'https://enatega-multivendor-api-production-7fed.up.railway.app/',

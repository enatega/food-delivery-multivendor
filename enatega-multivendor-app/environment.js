...
const useEnvVars = (env = Updates.channel) => {
  ...
  return {
    ...
    // WS_GRAPHQL_URL: 'wss://enatega-multivendor.up.railway.app/graphql',
    // SERVER_URL: 'https://enatega-multivendor.up.railway.app/',
    GRAPHQL_URL: 'https://yalla-multivendor-api.up.railway.app/graphql',
    WS_GRAPHQL_URL: 'ws://yalla-multivendor-api.up.railway.app/graphql',
    SERVER_URL: 'https://yalla-multivendor-api.up.railway.app/',

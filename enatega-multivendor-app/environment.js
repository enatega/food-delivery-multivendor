...
const getEnvVars = (configuration, env = Updates.releaseChannel) => {
  ...
  return {
    GRAPHQL_URL: 'http://192.168.18.97:8001/graphql',
    WS_GRAPHQL_URL: 'ws://192.168.18.97:8001/graphql',
    SERVER_URL: 'ws://192.168.18.97:8001/',
...
export const fetchAndSetEnvVars = async client => {
  try {
    const configuration = getConfigData()
    getEnvVars(configuration)
  } catch (error) {

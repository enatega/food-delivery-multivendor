...
const SecuritySettingsHeader = ({ currentTheme, onBack }) => {
    ...
    <View style={styles(currentTheme).header}>
      ...
      <View style={styles(currentTheme).titleContainer}>
        <TextDefault
          ...
          bolder
        >
          {t('securityAndSettings', { defaultValue: 'Security & settings' })}
        </TextDefault>
        <TextDefault
          ...
          bold
        >
          {t('managePasswordLanguagePreferences', {
            defaultValue: 'Manage your password, language, and privacy preferences'
          })}
        </TextDefault>
      </View>
    </View>

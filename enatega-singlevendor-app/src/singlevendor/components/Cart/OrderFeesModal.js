          ...
          <View style={styles().table}>
            ...
            <View style={[styles().tableRow, styles().tableRowData]}>
              <TextDefault
                ...
                style={styles().tableCell}
              >
                {minimumOrder}&nbsp;{currencySymbol}:00 - {(lowOrderFeeThreshold - 0.01).toFixed(2)}&nbsp;{currencySymbol}
              </TextDefault>
              <TextDefault
                textColor={currentTheme.fontMainColor}
                Normal
            ...
            <View style={[styles().tableRow, styles().tableRowData]}>
              <TextDefault
                ...
                style={styles().tableCell}
              >
                {lowOrderFeeThreshold}&nbsp;{currencySymbol} - & above
              </TextDefault>
              <TextDefault
            ...
            >
              * For orders less than{' '}
              <TextDefault
                ...
                small
              >
                {lowOrderFeeThreshold}&nbsp;{currencySymbol}
              </TextDefault>

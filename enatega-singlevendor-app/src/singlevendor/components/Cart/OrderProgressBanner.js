...
const OrderProgressBanner = ({
  ...
  const getState = () => {
    ...
    if (currentTotal < minimumOrder) {
      ...
      return {
        text: t("You can't place order below ") || "You can't place order below ",
        boldText: `${minimumOrder}${currencySymbol}`,
    ...
    // State 2: Just reached minimum order
      ...
      return {
        text: t("You've reached minimum spend limit") || "You've reached minimum spend limit",
        boldText: null,
        progress1: 33.33,
        progress2: 0,
        progress3: 0
    ...
    // State 3: Above minimum but low-order fee applies
      ...
      return {
        text: `A `,
        boldText: `${lowOrderFee}${currencySymbol}`,
        text2: ` ${t('low-order fee applies') || 'low-order fee applies'}`,
        progress1: 33.33,
    ...
    // State 4: Close to avoiding fee
      ...
      return {
        text: `Add `,
        boldText: `${remaining}${currencySymbol}`,
        text2: ` more to avoid the `,
        boldText2: `${lowOrderFee}${currencySymbol}`,
        text3: ` low-order fee`,
        progress1: 33.33,
        progress2: Math.min(progress, 33.33),
        progress3: 0

        ...
        {isOAuthUser
          ...
          <View style={styles(currentTheme).oauthNoticeContainer}>
            <TextDefault
              ...
              bolder
            >
              {t('oauthLoginDetected', {
                provider: oAuthProvider,
                defaultValue: '{{provider}} login detected'
              })}
            </TextDefault>
            <TextDefault
            ...
            >
              {t('oauthPasswordChangeMessage', {
                provider: oAuthProvider,
                defaultValue: 'Your password is managed by {{provider}}. Change it from your {{provider}} account.'
              })}
            </TextDefault>
          </View>
            )

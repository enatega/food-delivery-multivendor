...
function AmplitudeApiKeyConfiguration(props) {
  ...
  const [mutate, { loading }] = useMutation(SAVE_AMPLITUDE_API_KEY_CONFIGURATION);
        ...
        <form ref={formRef}>
          ...
          Web Amplitude API Key
            ...
            <Input
             style={{ marginTop: -1 }}
              ...
              onBlur={(event) =>
                onBlur(setWebAmplitudeApiKeyError, 'webAmplitudeApiKey', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
          ...
          App Amplitude API Key
            ...
            <Input
              ...
              onBlur={(event) =>
                onBlur(setAppAmplitudeApiKeyError, 'appAmplitudeApiKey', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,

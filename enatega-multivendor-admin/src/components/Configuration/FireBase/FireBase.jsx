    ...
    <Box container className={classes.container}>
      ...
      <Box className={classes.form}>
        <form ref={formRef}>
          ...
          <Box>
            <Typography className={classes.labelText}>Firebase Key</Typography>
            <Input
              style={{ marginTop: -1 }}
...
<Box>
  <Typography className={classes.labelText}>Storage Bucket</Typography>
  <Input
    style={{ marginTop: -1 }}
    ...
    onBlur={(event) =>
      onBlur(setStorageBucketError, 'storageBucket', event.target.value)
    }
    disableUnderline
    className={[
      globalClasses.input,
...
<Box className={globalClasses.flexRow}>
<Box>
  <Typography className={classes.labelText}>Message Sender ID</Typography>
  <Input
    style={{ marginTop: -1 }}
...
<Box>
  <Typography className={classes.labelText}>Measurement ID</Typography>
  <Input
    style={{ marginTop: -1 }}
    ...
    onBlur={(event) =>
      onBlur(setMeasurementIdError, 'measurementId', event.target.value)
    }
    disableUnderline
    className={[
      globalClasses.input,

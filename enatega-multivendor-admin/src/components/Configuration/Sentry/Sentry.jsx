...
function SentryConfiguration(props) {
  ...
  const [customerAppSentryUrlError, setCustomerAppSentryUrlError] = useState(null);
  const [restaurantAppSentryUrlError, setRestaurantAppSentryUrlError] = useState(null);
  ...
  const validateInput = () => {
    ...
    customerAppSentryUrlResult = !validateFunc(
      { customerAppSentryUrl: formRef.current['input-customerAppSentryUrl'].value },
      'customerAppSentryUrl'
    );
    restaurantAppSentryUrlResult = !validateFunc(
      { restaurantAppSentryUrl: formRef.current['input-restaurantAppSentryUrl'].value },
        ...
        <form ref={formRef}>
          ...
          Dashboard Sentry URL
            ...
            <Input
              ...
              type="password"
              onBlur={(event) =>
                onBlur(setDashboardSentryUrlError, 'dashboardSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
          ...
          <Box className={globalClasses.flexRow}>
            ...
            <Input
              ...
              type="password"
              onBlur={(event) =>
                onBlur(setWebSentryUrlError, 'webSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
            ...
            <Input
              ...
              type="password"
              onBlur={(event) =>
                onBlur(setApiSentryUrlError, 'apiSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
          ...
          <Box className={globalClasses.flexRow}>
            ...
            <Input
              ...
              onBlur={(event) =>
                onBlur(setCustomerAppSentryUrlError, 'customerAppSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
            ...
            <Input
              ...
              type="password"
              onBlur={(event) =>
                onBlur(setRestaurantAppSentryUrlError, 'restaurantAppSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,
          ...
          Rider App Sentry URL
            ...
            <Input
              ...
              type="password"
              onBlur={(event) =>
                onBlur(setRiderAppSentryUrlError, 'riderAppSentryUrl', event.target.value)
              }
              disableUnderline
              className={[
                globalClasses.input,

        ...
        <Formik initialValues={{}} onSubmit={() => handleSave(restaurant._id)}>
          {({ handleSubmit, isSubmitting }) => (
            <Form onSubmit={handleSubmit}>
              <CustomButton
                type="submit"
                className="mt-2 flex h-10 w-24 rounded-md border border-gray-500 bg-white dark:bg-dark-950 px-4 text-black transition-colors duration-200 hover:bg-black hover:text-white"
                label={t('Save')}
                rounded={false}

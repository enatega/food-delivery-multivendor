...
function VendorSidebar({ children }: IGlobalComponentProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <nav
          className={`flex h-full flex-col border-r bg-white dark:bg-dark-950 shadow-sm transition-opacity duration-300 ${isVendorSidebarVisible ? 'opacity-100' : 'pointer-events-none opacity-0'}`}
        >

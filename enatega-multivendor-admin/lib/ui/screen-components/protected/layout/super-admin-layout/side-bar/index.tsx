...
function SuperAdminSidebar({ children }: IGlobalComponentProps) {
  ...
  return (
    <div className="relative dark:text-white">
      ...
      >
        <nav
          className={`flex h-full flex-col border-r bg-white dark:bg-dark-900 dark:border-dark-600 dark:text-white shadow-sm transition-opacity duration-300 ${isSuperAdminSidebarVisible ? 'opacity-100' : 'pointer-events-none opacity-0'}`}
        >

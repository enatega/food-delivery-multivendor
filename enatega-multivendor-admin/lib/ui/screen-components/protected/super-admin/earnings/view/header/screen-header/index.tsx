...
import { IEarningsHeaderComponentProps } from '@/lib/utils/interfaces/earnings.interface';
import { faDollarSign } from '@fortawesome/free-solid-svg-icons';
import { useTranslations } from 'next-intl';
// import { useState } from 'react';

const EarningsSuperAdminHeader = ({ earnings }: IEarningsHeaderComponentProps) => {
